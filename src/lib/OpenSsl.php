...
class Openssl implements CryptInterface
{
    ...
    public function __construct()
    {
        ...
        $methodPrefs = array_fill_keys(self::$methodPrefs, false);
    ...
    public static function encrypt($plaintext, $base64 = true)
    {
        ...
        if (stripos(self::$method, '-gcm') === false) {  // If not a GCM-based encryption method
     ...
     * @static
     */
    public static function decrypt($ciphertext, $base64 = true)
    {
        if (!empty($base64)) {
        ...
        $hmacLen = stripos(self::$method, '-gcm') === false ? 32 : 0;
